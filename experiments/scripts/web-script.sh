...
sudo rm ~/pcaps/web/web-trace.json &>/dev/null

sudo tar -czf ~/pcaps/scenario$1-web-5g.tar.gz ~/pcaps/web &>/dev/null
ssh -q $SERVER_IP "sudo tar -czf ~/pcaps/scenario$1-web-5g.tar.gz ~/pcaps/web" &>/dev/null
